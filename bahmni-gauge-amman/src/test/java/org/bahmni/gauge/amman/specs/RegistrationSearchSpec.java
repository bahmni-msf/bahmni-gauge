...
//
	...
	public void searchPreviouslyCreatedPatientWithName(){
		AmmanPatient recentlyCreatedPatient = SpecStoreHelper.getLatest(AmmanPatient.class);
		registrationSearch.searchByName(recentlyCreatedPatient.getPatientAttributeDataFor("firstName"));
	}
//
