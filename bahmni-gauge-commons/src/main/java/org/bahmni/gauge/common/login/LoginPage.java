...
public class LoginPage extends BahmniPage{
	...
	public void login(String username, String password){
        login(username,password,System.getenv("BAHMNI_GAUGE_APP_LOCATION"),System.getenv("BAHMNI_GAUGE_APP_LOCALE"));
	}

    public void login(String username, String password, String location){
        login(username,password,location,System.getenv("BAHMNI_GAUGE_APP_LOCALE"));
    }
