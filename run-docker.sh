...
sudo docker run -v /var/go/.m2:/root/.m2:rw -v $PWD:/gauge -e ENV=$1 -e TAGS=$2 -e BAHMNI_GAUGE_APP_PASSWORD=$BAHMNI_GAUGE_APP_PASSWORD  -i anallytics/docker-gauge-chromedriver:latest -- sh run.sh
