...
#docker run -v /var/go/.m2:/root/.m2:rw -v $PWD:/gauge -e ENV=$1 -e TAGS=$2 -i anallytics/docker-gauge-chromedriver:latest -- sh run.sh
docker run -v ~/.m2:/root/.m2:rw -v $PWD:/gauge -e ENV=$1 -e TAGS=$2 -i anallytics/docker-gauge-chromedriver:latest -- sh run.sh
